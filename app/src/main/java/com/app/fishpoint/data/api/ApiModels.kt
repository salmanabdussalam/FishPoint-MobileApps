...
data class SpotRequest(val action: String, val id: Int = 0, val user_id: Int, val name: String, val water_type: String, val category: String = "", val latitude: Double, val longitude: Double, val target_fish: String = "", val description: String = "", val retained_photos: List<String> = emptyList())
